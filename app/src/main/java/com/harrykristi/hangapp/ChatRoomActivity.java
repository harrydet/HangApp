...
import com.harrykristi.hangapp.Adapters.ChatRoomThreadAdapter;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String selfUserId = RootApplication.getmInstance().getPrefManager().getUser().getId();
    ...
    private void sendMessage() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error") == false) {
                        ...
                        String userFirstName = userObj.getString("first_name");
                        String userLastName = userObj.getString("last_name");
                        User user = new User(userId, userFirstName, userLastName, null);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_id", RootApplication.getmInstance().getPrefManager().getUser().getId());
